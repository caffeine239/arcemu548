...
void WorldSession::HandleBuyBackOpcode(WorldPacket & recv_data)
{
	...
	if(it)
	{
		...
		// Check for gold
		int32 cost = _player->GetUInt32Value(PLAYER_FIELD_BUYBACK_PRICE + stuff);
...
void WorldSession::HandleBuyBankSlotOpcode(WorldPacket & recvPacket)
{
	...
	bytes = GetPlayer()->GetUInt32Value(PLAYER_FIELD_REST_STATE);
	...
	{
		_player->SetUInt32Value(PLAYER_FIELD_REST_STATE, (bytes & 0xff00ffff) | ((slots + 1) << 16));
		_player->ModGold(-price);
#ifdef ENABLE_ACHIEVEMENTS
...
////////////////////////////////// We remove the refunded item and refund the cost //////////////////////////////////
				...
				_player->GetItemInterface()->AddItemById(43308, ex->just_0_1, 0);     // honor points -- i don't think just_0_1 is correct
