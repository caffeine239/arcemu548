...
enum Flags6 // AttributesExE
{
    ...
    FLAGS6_UNK32						= 0x40000000, //CAST_FLAG_HEAL_PREDICTION
...
ARCEMU_INLINE bool IsTargetingStealthed(SpellEntry* sp)
{
	...
	/*if(
		...
		return 1;*/ //namehash is gone in cata?
...
const int32 MaxPowerType[14] = { -1, 1000, 100, 100, 1000, 8, 1000, 3, 100, 3 };
const int32 MinPowerType[14] = { -1, 0, 0, 0, 0, 0, 0, 0, -100, 0 };
