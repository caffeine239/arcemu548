...
class TotemofCoo : public QuestScript
{
	public:
		void OnQuestStart(Player* pPlayer, QuestLogEntry* pQuest)
		{
			...
			pAkida->SetUInt32Value(UNIT_FIELD_NPC_FLAGS, 0);
...
class TotemofTikti : public QuestScript
{
	public:
		...
		void OnQuestStart(Player* mTarget, QuestLogEntry* qLogEntry)
		{
			...
			Coo->SetUInt32Value(UNIT_FIELD_NPC_FLAGS, 0);
...
class TotemofYor : public QuestScript
{
	public:
		...
		void OnQuestStart(Player* mTarget, QuestLogEntry* qLogEntry)
		{
			...
			Tikti->SetUInt32Value(UNIT_FIELD_NPC_FLAGS, 0);
...
class TotemofVark : public QuestScript
{
	public:
		...
		void OnQuestStart(Player* mTarget, QuestLogEntry* qLogEntry)
		{
			...
			Yor->SetUInt32Value(UNIT_FIELD_NPC_FLAGS, 0);
			char msg[256];
