...
class Quest_JourneytoUndercity : public QuestScript // never extend std::tr1::enable_shared_from_this. EVER. :)
{
	public:
		...
		void OnQuestComplete(Player* mTarget, QuestLogEntry* qLogEntry)
		{
			...
			creat->SetUInt32Value(UNIT_FIELD_NPC_FLAGS, 0);
			...
			sEventMgr.AddEvent(TO_OBJECT(creat), &Object::EventSetUInt32Value, (uint32)UNIT_FIELD_NPC_FLAGS, (uint32)2, EVENT_SCRIPT_UPDATE_EVENT, 180000, 0, EVENT_FLAG_DO_NOT_EXECUTE_IN_WORLD_CONTEXT);
		}
};
