...
void RingOfValor::OnCreate(){
	...
	obj->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID,GAMEOBJECT_BYTES_STATE, 1);
	obj->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID,GAMEOBJECT_BYTES_ANIMPROGRESS, 100);
	m_gates.insert(obj);
