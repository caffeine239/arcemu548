...
void ArathiBasin::SpawnBuff(uint32 x)
{
	...
	if(m_buffs[x] == NULL)
	{
		...
		m_buffs[x]->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 0, 1);
		m_buffs[x]->SetType(GAMEOBJECT_TYPE_TRAP);
		m_buffs[x]->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 3, 100);
...
void ArathiBasin::SpawnControlPoint(uint32 Id, uint32 Type)
{
	...
	if(m_controlPoints[Id] == NULL)
	{
		...
		m_controlPoints[Id]->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 0, 1);
		m_controlPoints[Id]->SetType(static_cast<uint8>(gi->Type));
		m_controlPoints[Id]->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 3, 100);
	...
	if(m_controlPointAuras[Id] == NULL)
	{
		...
		m_controlPointAuras[Id]->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 0, 1);
		m_controlPointAuras[Id]->SetType(GAMEOBJECT_TYPE_TRAP);
		m_controlPointAuras[Id]->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 3, 100);
...
void ArathiBasin::OnCreate()
{
	...
	gate->SetByte(GAMEOBJECT_FIELD_STATE_SPELL_VISUAL_ID, 3, 100);
