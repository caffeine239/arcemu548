...
class SelinFireheartAI : public MoonScriptCreatureAI
{
		...
		void OnCombatStart(Unit* pTarget)
		{
			...
			*/
			_unit->SetUInt32Value(UNIT_FIELD_POWER, 0);
		...
		*/
		...
		void Mana()
		{
			...
			*/
			...
			_unit->SetUInt32Value(UNIT_FIELD_POWER, mana);
		...
		void CastFelExplosion()
		{
			...
			_unit->SetUInt32Value(UNIT_FIELD_POWER, _unit->GetPower(POWER_TYPE_MANA) - 3231);
		}
